...
from rocd_mod.message import (
    C, is_quiet, log_info,
)
from rocd_mod.constants import PROGRAM_NAME
from rocd_mod.progress import (
    clear_bar, fmt_size,
)
...
from rocd_mod.helpers.docker.refs import parse_image_ref
...
def push_image(image_ref: str, arch: str, insecure: bool = False) -> dict:
    ...
    The image must have been produced by `rocd build` under
