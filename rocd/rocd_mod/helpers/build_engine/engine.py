...
# Architecture: The stateful interpreter at the core of `rocd
...
from rocd_mod.arch import get_device_cpu_arch
from rocd_mod.message import C, log_info
from rocd_mod.helpers.docker import (
    ARCH_TO_DOCKER, apply_layer, layer_cache_path, pull_image,
)
from rocd_mod.helpers.dockerfile import expand_vars
from rocd_mod.helpers.rootfs import write_hosts, write_resolv_conf
from rocd_mod.helpers.build_engine.constants import (
    EXPANDS_VARS, PREDEFINED_ARGS,
)
from rocd_mod.helpers.build_engine.dockerignore import load_dockerignore
from rocd_mod.helpers.build_engine.errors import BuildError
from rocd_mod.helpers.build_engine.handlers import HANDLERS, do_onbuild
from rocd_mod.helpers.build_engine.parsing import split_arg
from rocd_mod.helpers.build_engine.stage import Stage
...
class BuildEngine:
    ...
    def _do_from(self, instr):
        ...
        if base_onbuild:
            from rocd_mod.helpers.dockerfile import parse_dockerfile
