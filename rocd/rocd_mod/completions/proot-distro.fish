# Fish completion for rocd and pd
#
# Install:
#   cp rocd.fish ~/.config/fish/completions/rocd.fish
#   cp rocd.fish ~/.config/fish/completions/pd.fish

# ---------------------------------------------------------------------------
# Helper: resolve installed containers directory
# ---------------------------------------------------------------------------
function __rocd_mod_containers
    set -l dir
    if __rocd_mod_is_termux
        set -l prefix
        ...
        set dir "$prefix/var/lib/rocd/containers"
    else if set -q XDG_DATA_HOME
        set dir "$XDG_DATA_HOME/rocd/containers"
    else
        set dir "$HOME/.local/share/rocd/containers"
    end
    if test -d "$dir"
        for d in "$dir"/*/
...
# ---------------------------------------------------------------------------
function __rocd_mod_no_subcommand
...
# Subcommands
# ---------------------------------------------------------------------------
complete -c rocd -f -n __rocd_mod_no_subcommand -a install     -d 'Install a container from a Docker image or local archive'
complete -c rocd -f -n __rocd_mod_no_subcommand -a remove      -d 'Remove an installed container'
complete -c rocd -f -n __rocd_mod_no_subcommand -a rename      -d 'Rename a container'
complete -c rocd -f -n __rocd_mod_no_subcommand -a reset       -d 'Reinstall a container from its original image'
complete -c rocd -f -n __rocd_mod_no_subcommand -a login       -d 'Open a shell inside a container'
complete -c rocd -f -n __rocd_mod_no_subcommand -a list        -d 'List installed containers'
complete -c rocd -f -n __rocd_mod_no_subcommand -a ps          -d 'List active container sessions'
complete -c rocd -f -n __rocd_mod_no_subcommand -a kill        -d 'Stop active container sessions'
complete -c rocd -f -n __rocd_mod_no_subcommand -a backup      -d 'Backup a container to a tar archive'
complete -c rocd -f -n __rocd_mod_no_subcommand -a restore     -d 'Restore a container from a tar archive'
complete -c rocd -f -n __rocd_mod_no_subcommand -a clear-cache -d 'Clear the download cache'
complete -c rocd -f -n __rocd_mod_no_subcommand -a copy        -d 'Copy files between host and container'
complete -c rocd -f -n __rocd_mod_no_subcommand -a sync        -d 'Synchronize files between host and container'
complete -c rocd -f -n __rocd_mod_no_subcommand -a run         -d 'Run the image entrypoint/cmd in a container'
complete -c rocd -f -n __rocd_mod_no_subcommand -a build       -d 'Build an OCI image from a Dockerfile'
complete -c rocd -f -n __rocd_mod_no_subcommand -a push        -d 'Push a locally built image to a registry'
complete -c rocd -f -n __rocd_mod_no_subcommand -a help        -d 'Show help'

# Global help flag (before subcommand)
complete -c rocd -f -n __rocd_mod_no_subcommand -s h -l help   -d 'Show help'

# ---------------------------------------------------------------------------
# install
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from install' \
...
# remove
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from remove' \
    -a '(__rocd_mod_containers)' -d 'Container'
complete -c rocd -f -n '__fish_seen_subcommand_from remove' \
...
# rename
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from rename' \
    -a '(__rocd_mod_containers)' -d 'Container'
complete -c rocd -f -n '__fish_seen_subcommand_from rename' \
    -s q -l quiet      -d 'Suppress non-error output'
complete -c rocd -f -n '__fish_seen_subcommand_from rename' \
...
# reset
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from reset' \
    -a '(__rocd_mod_containers)' -d 'Container'
complete -c rocd -f -n '__fish_seen_subcommand_from reset' \
    -s q -l quiet      -d 'Suppress non-error output'
complete -c rocd -f -n '__fish_seen_subcommand_from reset' \
...
# login
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from login' \
    -a '(__rocd_mod_containers)' -d 'Container'
complete -c rocd -f -n '__fish_seen_subcommand_from login' \
    -s u -l user       -r -d 'Run as this user (default: root)'
complete -c rocd -f -n '__fish_seen_subcommand_from login' \
    -s P -l redirect-ports -d 'Redirect ports below 1024 to unprivileged range'
complete -c rocd -f -n '__fish_seen_subcommand_from login; and __rocd_mod_is_termux' \
...
complete -c rocd -n '__fish_seen_subcommand_from login' \
...
# list
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from list' \
    -s q -l quiet      -d 'Suppress non-error output'
complete -c rocd -f -n '__fish_seen_subcommand_from list' \
    -s h -l help       -d 'Show help'
...
# ps
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from ps' \
...
# kill
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from kill' \
    -a '(__rocd_mod_containers)' -d 'Container'
complete -c rocd -f -n '__fish_seen_subcommand_from kill' \
...
# backup
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from backup' \
    -a '(__rocd_mod_containers)' -d 'Container'
complete -c rocd -n '__fish_seen_subcommand_from backup' \
...
# restore
# ---------------------------------------------------------------------------
complete -c rocd -n '__fish_seen_subcommand_from restore' \
...
# clear-cache
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from clear-cache' \
...
# copy
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from copy' \
    -a '(__rocd_mod_containers)' -d 'Container (use container:path notation)'
complete -c rocd -f -n '__fish_seen_subcommand_from copy' \
...
# sync
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from sync' \
    -a '(__rocd_mod_containers)' -d 'Container (use container:path notation)'
complete -c rocd -f -n '__fish_seen_subcommand_from sync' \
...
# run
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from run' \
    -a '(__rocd_mod_containers)' -d 'Container'
complete -c rocd -f -n '__fish_seen_subcommand_from run' \
    -s u -l user       -r -d 'Run as this user (default: root)'
complete -c rocd -f -n '__fish_seen_subcommand_from run' \
    -s P -l redirect-ports -d 'Redirect ports below 1024 to unprivileged range'
complete -c rocd -f -n '__fish_seen_subcommand_from run; and __rocd_mod_is_termux' \
    -l isolated           -d 'Isolated mode: no host env vars or Termux paths'
complete -c rocd -f -n '__fish_seen_subcommand_from run; and __rocd_mod_is_termux' \
    -l minimal            -d 'Like --isolated but also disables Android system bindings'
complete -c rocd -f -n '__fish_seen_subcommand_from run' \
...
complete -c rocd -f -n '__fish_seen_subcommand_from run' \
    -l shared-x11         -d 'Share the X11 socket (/tmp/.X11-unix)'
complete -c rocd -n '__fish_seen_subcommand_from run' \
    -s b -l bind       -r -d 'Bind-mount PATH[:DEST] into the container (repeatable)'
complete -c rocd -f -n '__fish_seen_subcommand_from run; and __rocd_mod_is_termux' \
    -l no-link2symlink    -d 'Disable proot link2symlink extension'
complete -c rocd -f -n '__fish_seen_subcommand_from run; and __rocd_mod_is_termux' \
...
# build
# ---------------------------------------------------------------------------
complete -c rocd -n '__fish_seen_subcommand_from build' \
    -s f -l file       -r -d 'Path to Dockerfile (- reads from stdin)'
complete -c rocd -f -n '__fish_seen_subcommand_from build' \
...
# push
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from push' \
    -s a -l architecture -r -d 'Target CPU architecture' \
    -a 'aarch64\tAArch64 arm\tARM(32-bit) i686\tx86(32-bit) riscv64\tRISC-V x86_64\tx86_64'
complete -c rocd -f -n '__fish_seen_subcommand_from push' \
...
# help
# ---------------------------------------------------------------------------
complete -c rocd -f -n '__fish_seen_subcommand_from help' \
...
# ---------------------------------------------------------------------------
complete -c pd -f -n __rocd_mod_no_subcommand -a install     -d 'Install a container from a Docker image or local archive'
complete -c pd -f -n __rocd_mod_no_subcommand -a remove      -d 'Remove an installed container'
complete -c pd -f -n __rocd_mod_no_subcommand -a rename      -d 'Rename a container'
complete -c pd -f -n __rocd_mod_no_subcommand -a reset       -d 'Reinstall a container from its original image'
complete -c pd -f -n __rocd_mod_no_subcommand -a login       -d 'Open a shell inside a container'
complete -c pd -f -n __rocd_mod_no_subcommand -a list        -d 'List installed containers'
complete -c pd -f -n __rocd_mod_no_subcommand -a ps          -d 'List active container sessions'
complete -c pd -f -n __rocd_mod_no_subcommand -a kill        -d 'Stop active container sessions'
complete -c pd -f -n __rocd_mod_no_subcommand -a backup      -d 'Backup a container to a tar archive'
complete -c pd -f -n __rocd_mod_no_subcommand -a restore     -d 'Restore a container from a tar archive'
complete -c pd -f -n __rocd_mod_no_subcommand -a clear-cache -d 'Clear the download cache'
complete -c pd -f -n __rocd_mod_no_subcommand -a copy        -d 'Copy files between host and container'
complete -c pd -f -n __rocd_mod_no_subcommand -a sync        -d 'Synchronize files between host and container'
complete -c pd -f -n __rocd_mod_no_subcommand -a run         -d 'Run the image entrypoint/cmd in a container'
complete -c pd -f -n __rocd_mod_no_subcommand -a build       -d 'Build an OCI image from a Dockerfile'
complete -c pd -f -n __rocd_mod_no_subcommand -a push        -d 'Push a locally built image to a registry'
complete -c pd -f -n __rocd_mod_no_subcommand -a help        -d 'Show help'
complete -c pd -f -n __rocd_mod_no_subcommand -s h -l help   -d 'Show help'
...
complete -c pd -f -n '__fish_seen_subcommand_from remove' -a '(__rocd_mod_containers)' -d 'Container'
...
complete -c pd -f -n '__fish_seen_subcommand_from rename' -a '(__rocd_mod_containers)' -d 'Container'
...
complete -c pd -f -n '__fish_seen_subcommand_from reset' -a '(__rocd_mod_containers)' -d 'Container'
...
complete -c pd -f -n '__fish_seen_subcommand_from login' -a '(__rocd_mod_containers)' -d 'Container'
...
complete -c pd -f -n '__fish_seen_subcommand_from login; and __rocd_mod_is_termux' -l isolated -d 'Isolated mode'
complete -c pd -f -n '__fish_seen_subcommand_from login; and __rocd_mod_is_termux' -l minimal  -d 'Minimal isolated mode'
...
complete -c pd -f -n '__fish_seen_subcommand_from login; and __rocd_mod_is_termux' -l no-link2symlink -d 'Disable link2symlink'
complete -c pd -f -n '__fish_seen_subcommand_from login; and __rocd_mod_is_termux' -l no-sysvipc     -d 'Disable SysV IPC'
complete -c pd -f -n '__fish_seen_subcommand_from login; and __rocd_mod_is_termux' -l no-kill-on-exit -d 'Do not kill on exit'
...
complete -c pd -f -n '__fish_seen_subcommand_from kill' -a '(__rocd_mod_containers)' -d 'Container'
...
complete -c pd -f -n '__fish_seen_subcommand_from backup' -a '(__rocd_mod_containers)' -d 'Container'
...
complete -c pd -f -n '__fish_seen_subcommand_from copy' -a '(__rocd_mod_containers)' -d 'Container'
...
complete -c pd -f -n '__fish_seen_subcommand_from sync' -a '(__rocd_mod_containers)' -d 'Container'
...
complete -c pd -f -n '__fish_seen_subcommand_from run' -a '(__rocd_mod_containers)' -d 'Container'
...
complete -c pd -f -n '__fish_seen_subcommand_from run; and __rocd_mod_is_termux' -l isolated -d 'Isolated mode'
complete -c pd -f -n '__fish_seen_subcommand_from run; and __rocd_mod_is_termux' -l minimal  -d 'Minimal isolated mode'
...
complete -c pd -f -n '__fish_seen_subcommand_from run; and __rocd_mod_is_termux' -l no-link2symlink -d 'Disable link2symlink'
complete -c pd -f -n '__fish_seen_subcommand_from run; and __rocd_mod_is_termux' -l no-sysvipc     -d 'Disable SysV IPC'
complete -c pd -f -n '__fish_seen_subcommand_from run; and __rocd_mod_is_termux' -l no-kill-on-exit -d 'Do not kill on exit'
...
complete -c pd -f -n '__fish_seen_subcommand_from build' -l install-as        -r -d 'Install image as a local container after build' -a '(__rocd_mod_containers)'
