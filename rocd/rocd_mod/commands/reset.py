...
from rocd_mod.message import log_info, log_error, crit_error
from rocd_mod.commands.remove import _remove_path
...
from rocd_mod.paths import container_manifest, container_rootfs
