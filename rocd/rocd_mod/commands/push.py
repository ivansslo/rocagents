...
# Architecture: Top-level orchestration for `rocd push`. The
# image must have been produced by `rocd build -t IMAGE` first;
...
from rocd_mod.constants import PROGRAM_NAME


def command_push(args):
    """Implements `rocd push`."""
