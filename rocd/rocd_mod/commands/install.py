...
from rocd_mod.atomic import atomic_replace
from rocd_mod.constants import BASE_CACHE_DIR, PROGRAM_NAME
from rocd_mod.message import C, msg, log_info, log_error, crit_error
from rocd_mod.progress import clear_bar
from rocd_mod.locking import ContainerLock
from rocd_mod.arch import get_device_cpu_arch, normalize_arch
from rocd_mod.names import is_valid_name, require_valid_name
from rocd_mod.paths import (
    container_dir, container_manifest, container_rootfs,
)
from rocd_mod.sysdata import setup_fake_sysdata
from rocd_mod.helpers.docker import derive_alias, pull_image
from rocd_mod.helpers.rootfs import (
    register_android_ids,
    write_hosts,
    write_resolv_conf,
)
from rocd_mod.helpers.download import download_file
from rocd_mod.commands.install_local import install_from_local_file
...
def _run_install(
    ...
    try:
        ...
        log_error(
            "See 'rocd install --help' on how to install "
            "distribution image."
        )
        _cleanup()
        sys.exit(1)
