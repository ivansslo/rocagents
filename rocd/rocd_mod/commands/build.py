...
# Architecture: Top-level orchestration for `rocd build`.
...
from rocd_mod.constants import (
    PROGRAM_NAME,
    RUNTIME_DIR,
)
from rocd_mod.paths import container_rootfs
from rocd_mod.message import C, msg, log_info, log_error, crit_error
from rocd_mod.locking import BuildLock
from rocd_mod.arch import get_device_cpu_arch, normalize_arch
from rocd_mod.helpers.dockerfile import (
    DockerfileSyntaxError,
    parse_dockerfile,
)
from rocd_mod.helpers.build_engine import (
    BuildEngine,
    BuildError,
    needs_proot,
)
from rocd_mod.helpers.oci_writer import (
    build_manifest_and_config,
    store_in_cache,
    write_oci_archive,
)
from rocd_mod.helpers.docker import ARCH_TO_DOCKER
from rocd_mod.names import is_valid_name, require_valid_name
from rocd_mod.progress import fmt_size
...
def command_build(args):
    ...
    if needs_proot(instructions):
        from rocd_mod.cli import ensure_proot_installed
