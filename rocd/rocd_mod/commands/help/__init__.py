...
from rocd_mod.constants import PROGRAM_NAME, RUNTIME_DIR
from rocd_mod.message import C, msg
from rocd_mod.commands.help.pages import HELP_PAGES, TOP_COMMANDS
from rocd_mod.commands.help.render import (
    commands_block,
    footer,
    paragraph,
    render_page,
...
def command_help(args=None) -> None:
    ...
    *args* is accepted for signature uniformity with the other
    ...
    paragraph(
        ...
        f"Read documentation at https://github.com/termux/rocd/blob/master/README.md",
        width,
    )
    ...
    paragraph(
        ...
        "https://github.com/termux/rocd/issues",
        width,
    )
