...
#     rocd-set vars when a login shell re-sources /etc/profile.
...
# Vars the image Env must not override. Some are rocd-defined
...
def inject_termux_profile(rootfs: str, env: dict) -> None:
    ...
    rocd-defined var — Termux baseline (MOZ_FAKE_NO_SANDBOX,
    ...
    rocd value wins. Per-session vars and proot-internal vars
