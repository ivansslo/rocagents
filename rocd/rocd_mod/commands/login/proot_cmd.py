...
from rocd_mod.message import crit_error, warn
from rocd_mod.arch import ARCH_UNAME_M
from rocd_mod.sysdata import fake_proc_bindings
from rocd_mod.commands.login.bindings import (
...
def _add_non_minimal_binds(
    ...
    *,
    ...
    # Ensure essential bind mount points physically exist inside rootfs
    for d in ["root", "tmp", "proc", "sys", "dev", "etc"]:
        try:
