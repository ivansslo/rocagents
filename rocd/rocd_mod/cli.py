...
from rocd_mod.constants import IS_TERMUX, PROGRAM_NAME
from rocd_mod.message import C, msg, set_quiet, crit_error
from rocd_mod.arch import get_proot_bin
from rocd_mod.parser import (
    ALIAS_TO_CANONICAL, REQUIRED_ARGS, build_parser,
)
from rocd_mod.commands.help import command_help, HELP_COMMANDS
from rocd_mod.commands.install import command_install
from rocd_mod.commands.remove import command_remove
from rocd_mod.commands.rename import command_rename
from rocd_mod.commands.reset import command_reset
from rocd_mod.commands.login import command_login
from rocd_mod.commands.list import command_list
from rocd_mod.commands.backup import command_backup
from rocd_mod.commands.restore import command_restore
from rocd_mod.commands.clear_cache import command_clear_cache
from rocd_mod.commands.copy import command_copy
from rocd_mod.commands.sync import command_sync
from rocd_mod.commands.run import command_run
from rocd_mod.commands.build import command_build
from rocd_mod.commands.push import command_push
from rocd_mod.commands.ps import command_ps
from rocd_mod.commands.kill import command_kill
...
def main() -> None:
    """CLI entry point — installed as both `rocd` and `pd`.
