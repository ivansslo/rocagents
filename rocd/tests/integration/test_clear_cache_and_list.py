...
from rocd_mod.constants import LAYER_CACHE_DIR, MANIFEST_CACHE_DIR
from rocd_mod.helpers import build_cache
...
def test_clear_cache_empty_is_safe(capsys):
    import shutil
    from rocd_mod.constants import BASE_CACHE_DIR
