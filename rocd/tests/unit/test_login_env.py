# Tests for rocd_mod.commands.login.env — image Env harvesting and the
# /etc/profile.d snippet injector.

import os

from rocd_mod.commands.login import env as login_env
from rocd_mod.paths import container_dir
